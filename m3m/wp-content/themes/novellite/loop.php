...
if (have_posts()) : while (have_posts()) : the_post(); ?>
      ...
      <a href="<?php the_permalink() ?>"> <?php the_post_thumbnail(); ?></a>			 
			...
			<div class="post_thumbnil">
			<?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) { ?>
             <a class="image-hvr" href="<?php the_permalink() ?>"> <span class="image_link2 quote"></span><?php the_post_thumbnail(); ?></a>			 
             <?php } ?>
			...
			<?php } else { ?>
             <div class="post_thumbnil">
			<?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) { ?>
             <a class="image-hvr" href="<?php the_permalink() ?>"> <span class="image_link2"></span><?php the_post_thumbnail(); ?>			 
             <?php } ?>
			</div>
			<?php } ?>
